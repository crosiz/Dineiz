...
- Name: apps\pos\tests\e2e\orders.spec.ts >> 3.2 Table status — turns occupied (red border) after order sent to kitchen
- Location: apps\pos\tests\e2e\orders.spec.ts:151:5
