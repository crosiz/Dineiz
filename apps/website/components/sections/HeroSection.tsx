      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-10 items-center">
          ...
          >
            ...
            >
              Billing, kitchen &amp; WhatsApp orders — one screen, GST-ready.
            </h1>

            <p className="text-[#6e6e73] text-lg leading-relaxed mb-9 max-w-lg">
              Punch orders, print receipts, and take WhatsApp orders from one system —
              built for how restaurants actually run, with JazzCash, EasyPaisa and card payments
          ...
          >
            ...
            <div className="absolute left-0 top-6 w-[72%] -rotate-[5deg] rounded-xl border border-[#d2d2d7] bg-[#fffdf7] shadow-[0_16px_40px_rgba(0,0,0,0.09)] p-5 font-mono">
            ...
            {/* Receipt — front layer */}
            <div className="absolute right-0 bottom-0 w-[70%] rotate-[3deg] rounded-xl border border-[#d2d2d7] bg-white shadow-[0_20px_48px_rgba(0,0,0,0.12)] p-6">
              ...
              <div className="space-y-2 text-[13px] mb-4">
                ...
                <div className="flex justify-between text-[#6e6e73]">
                  <span>GST / Tax</span><span className="text-[#1d1d1f] font-medium">Rs. 376</span>
                </div>
              ...
              <div className="flex justify-center py-2 border-t border-dashed border-[#e5e5ea]">
                <div className="grid grid-cols-7 gap-[3px]">
                  {Array.from({ length: 49 }).map((_, i) => (
                    <span
                      key={i}
                      className={`w-[5px] h-[5px] rounded-[1px] ${(i * 13 + 4) % 3 === 0 ? "bg-[#1d1d1f]" : "bg-transparent"}`}
                    />
                  ))}
                </div>
              </div>
