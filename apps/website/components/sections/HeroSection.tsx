      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-10 items-center">
          ...
          >
            ...
            >
              Billing, kitchen &amp; WhatsApp orders — one screen, FBR-ready.
            </h1>

            <p className="text-[#6e6e73] text-lg leading-relaxed mb-9 max-w-lg">
              Punch orders, print FBR receipts, and take WhatsApp orders from one system —
              built for how Pakistani restaurants actually run, with JazzCash and EasyPaisa
          ...
          >
            ...
            <div className="absolute right-0 bottom-0 w-[70%] rotate-[3deg] rounded-xl border border-[#d2d2d7] bg-white shadow-[0_20px_48px_rgba(0,0,0,0.12)] p-6">
              <div className="text-center mb-4">
                ...
                <div className="text-[10px] text-[#9a9a9f] mt-0.5">FBR-verified receipt</div>
              </div>
