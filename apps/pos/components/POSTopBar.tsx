                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (shiftObj?.shiftId && sessionObj?.token) {
                      ...
                      // Local audit-trail record — the break API call above
                      // is still what the server actually relies on; this
                      // just keeps the local event log complete.
                      startBreak(shiftObj.shiftId).catch(console.error);
                    }
                  } catch {
