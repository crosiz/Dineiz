            ...
            <div className="p-4 border-b border-[#E2E8F0] shrink-0">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-3 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl text-[16px] text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-[var(--pos-primary,#F59E0B)]/20 focus:border-[var(--pos-primary,#F59E0B)] transition-all"
                />
              </div>
            </div>
