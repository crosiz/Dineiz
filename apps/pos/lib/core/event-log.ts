...
export type EventType =
  ...
  | 'ITEM_QTY_CHANGED' | 'ORDER_SENT_TO_KITCHEN' | 'ORDER_MARKED_READY'
  | 'ORDER_COMPLETED' | 'ORDER_CANCELLED' | 'ORDER_VOIDED'
  | 'PAYMENT_COLLECTED' | 'DISCOUNT_APPLIED' | 'DISCOUNT_REMOVED'
  | 'TABLE_STATUS_CHANGED' | 'SHIFT_OPENED' | 'SHIFT_CLOSED'
  | 'BREAK_STARTED' | 'BREAK_ENDED' | 'KOT_PRINTED' | 'RECEIPT_PRINTED';
