...
export function AssignWaiterSheet({
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl z-[501] flex flex-col shadow-[0_-10px_40px_rgba(0,0,0,0.1)] transition-transform duration-300 transform translate-y-0 max-h-[85dvh]">
