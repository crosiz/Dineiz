...
export const CustomerCreateSchema = z.object({
  ...
  birthDate: z.preprocess((val) => val === '' ? undefined : val, z.coerce.date().nullable().optional()),
  anniversary: z.preprocess((val) => val === '' ? undefined : val, z.coerce.date().nullable().optional()),
